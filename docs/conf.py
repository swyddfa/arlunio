...
# documentation.
#
html_theme_options = {"accent_color": "#ff0000"}
...
latex_documents = [
    (master_doc, "Stylo.tex", "Stylo Documentation", "Alex Carney", "manual")
]
...
man_pages = [(master_doc, "stylo", "Stylo Documentation", [author], 1)]
