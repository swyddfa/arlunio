...
These previous releases are no longer relevant to the project but are still
described here for historical interest.

.. note::

   This project was previously named :code:`stylo`
