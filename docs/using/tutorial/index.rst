...
.. only:: html
   ...
   .. note::
      ...
      :code:`arlunio` setup on your machine. It can be launched by running the command::
...
Welcome to arlunio's tutorial! If this is your first time here please do take the
...
particular aspect of arlunio. The sections are self contained so feel free to
...
- **Background:** There are a number of mathematical concepts at play in the
  core of arlunio. While it's not necessary to understand them it can certainly
...
.. only:: nbtutorial
   ...
   to develop an intuition for how the various concepts in arlunio interact is to
   ...
   relaunch the tutorial with the command :code:`arlunio tutorial --reset` which
